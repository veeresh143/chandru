...
<form name="add_staff" action="add_staff_exec.php" method="post">
  ...
  <tr>
    ...
    <td bgcolor="#335566"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="150" align="center" bgcolor="#FFFFFF"><a href="index.php"><img src="images/logo1.jpg" alt="Home" width="119" height="100" border="0"></a></td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
              ...
              <td align="center"><a href="index.php"><img src="images/title.png" width="500" height="60" border="0"></a></td>
            	  </tr>
           	   <tr>
      ...
      <TD width="600" align="center" valign="top"><br>
        ...
        <tr>
          ...
          <td height="120" align="center" valign="top">
               <marquee><h1> WEL COME TO STAFF PROFILE</h1></marquee>
 <h4 align="right"><font color="#FF0000">*</font>Mandetory Field</h4>
    ...
    <table align="center" class="table" cellspacing="6" width="10%">
       ...
       <tr class="formfieldheading">
        <td colspan="3">
         <strong>Staff Information</strong>        </td>
      </tr>
       <tr>
        <td width="10%" valign="center"> <img src="images/formbullet.gif">&nbsp;&nbsp;Staff ID<font color=red>*</font>
        </td>

        <td width="60%" colspan="2">
                 <input  name="staff_id" type=text  maxlength=30 id="staff_id" value=''>
       </td>
      </tr>
      <tr>
        <td width="10%" valign="center"> <img src="images/formbullet.gif">&nbsp;&nbsp;First NAME<font color=red>*</font>
        </td>
      ...
      <tr>
        <td valign="top"><img src="images/formbullet.gif">&nbsp;&nbsp;Date Of Joining(Department)<font color=red>*</font> : </td>
       
             <td colspan="2"><input name="date_of_joining_department" type=text maxlength=30 size=40 id="date_of_joining_department"  value=''> <br>
                 
          </td>
      </tr>
     
      <tr>
        <td valign="top"><img src="images/formbullet.gif">&nbsp;&nbsp;Date Of Joining(Police Station)<font color=red>*</font> : </td>
        
              <td colspan="2"><input name="date_of_joining_police_station" type=text maxlength=30 size=40 id="date_of_joining_police_station"  value='' ><br>
      ...
      <tr>
        ...
        <td>
         <img src="images/formbullet.gif">&nbsp;&nbsp;Caste<font color=red>*</font> :        </td>
        <td colspan="2">
          <select name="caste" id="caste">
               <option value='General'>General</option>
              <option value='OBC'>OBC</option>
              <option value='SC'>SC</option>
              <option value="ST">ST</select>
        </td>
      </tr>

     <tr>
        <td valign="top"><img src="images/formbullet.gif">&nbsp;&nbsp;Designation <font color=red>*</font> : </td>
        <td colspan="2">
            <select name="designation" id="designation">
                <option value="Inspector">Inpector</option>
        ...
        <tr>
        <td valign="top"><img src="images/formbullet.gif">&nbsp;&nbsp;Experience<font color=red>*</font> : </td>
        <td colspan="2">
      ...
      <tr class="formfieldheading">
        ...
        <td colspan="3">
         <strong>Personal Address</strong>        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td>
          <img src="images/formbullet.gif">&nbsp;&nbsp;Pincode<font color=red>*</font>
        </td>
        <td colspan="2">
        <input name="pincode" type=text id="pincode" size=4 maxlength=6 value='' onKeyUp="javascript:is_valid_numbers(this);">
        </td>
      ...
      <tr>
        <td>
          <img src="images/formbullet.gif">&nbsp;&nbsp;Mobile :
         </td>
        <td colspan="2">
        <input name="mobile" type=text id="mobile" size=15 maxlength=10 value='' onKeyUp="javascript:is_valid_numbers(this);">
        </td>
      </tr>

      <tr>
    <td>
    	<img src="images/formbullet.gif">&nbsp;&nbsp;Blood Group
    </td>
    <td colspan="2">
...
<tr class="formfieldheading">
        ...
        <td colspan="3">
            ...
            <input type="radio" onselect="sameAddress()">Same As Personal Address
  ...
  <tr>
        <td>
         <img src="images/formbullet.gif">&nbsp;&nbsp;Line 1<font color=red>*</font> :
        </td>
        <td colspan="2">
        <input name="line11" type=text id="line11" size=40 value='' maxlength=30>
        </td>

      </tr>
      <tr>
        <td>
          <img src="images/formbullet.gif">&nbsp;&nbsp;Line 2<font color=red>*</font> :
        </td>
        <td colspan="2">
        <input name="line22" type=text id="line22" size=40 value='' maxlength=30 >
        </td>
      ...
      <tr>
        <td>
          <img src="images/formbullet.gif">&nbsp;&nbsp;Line 3 :        </td>
        <td colspan="2">
        <input name="line33" type=text id="line33" size=40 value='' maxlength=30>
        </td>
      </tr>
      <tr>

        <td>
          <img src="images/formbullet.gif">&nbsp;&nbsp;District/City<font color=red>*</font> :
        </td>
        <td colspan="2">
        <input name="district1" type=text id="district1" size=40 value='' maxlength=30 onKeyUp="javascript:is_valid_char(this);">
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td><img src="images/formbullet.gif">&nbsp;&nbsp;Pincode<font color=red>*</font> :
        </td>
        <td colspan="2">
        <input name="pincode1" type=text id="pincode1" size=4 maxlength=6 value='' onKeyUp="javascript:is_valid_numbers(this);">
        </td>

      </tr>
	        <tr>
        <td>
          <img src="images/formbullet.gif">&nbsp;&nbsp;Phone with Area Code<font color=red>*</font> :
        </td>
        <td colspan="2">
  <input name="phone_no11" type=text id="phone_no11" size=4 maxlength=5 onKeyUp="javascript:is_valid_numbers(this);">
  <input name="phone_no22" type=text id="phone_no22" size=12 maxlength=8 onKeyUp="javascript:is_valid_numbers(this);">
        </td>
      </tr>

      <tr>
        <td>
          <img src="images/formbullet.gif">&nbsp;&nbsp;Mobile <font color=red>*</font>:
        </td>
        <td colspan="2">
        <input name="mobile1" type=text id="mobile1" size=15 maxlength=10 value='' onKeyUp="javascript:is_valid_numbers(this);">
        </td>
      </tr>
      <tr>
