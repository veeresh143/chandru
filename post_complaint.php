...
?>
 <form method="post" name="FIR" action="post_complaint_exec.php">
...
<!-- #EndLibraryItem --><table width="1000"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <TBODY>
    <TR>
      ...
      <marquee><h1> REGISTER HERE </h1></marquee>
    ...
    <table align="center" class="table" cellspacing="6" width="85%">
      ...
      <tr>
        ...
        <td colspan="2">
        <input name="name" type="text" id="name" size="40" value='' maxlength="30" onKeyUp="javascript:is_valid_char(this);">
        <!input type="text" name="name" id="name" onkeyup="javascript:is_valid_char(this);">
        </td>
      ...
      <tr>
        ...
        <td colspan="2">
        <input name="address" type=text id="address" size=40  maxlength=40 value='' onKeyUp="javascript:is_valid_char(this);">
        </td>
      </tr>
     <tr>
...
<TABLE width="1000" border="0" align="center" cellPadding="0" cellSpacing="0" bgcolor="#ffffff">
        <TR>
          <TD vAlign="center" align="center"><div class="footer"><a href="index.php" class="textlink">Home</a> | <a href="aboutus.php" class="textlink">About Us</a> | <a href="contact.php" class="textlink">Contact Us</a>  | <a href="http://mail.ksp.gov.in" class="textlink">Email Login</a> | <a href="sitemap.php" class="textlink">Site Map</a></div></TD>
